<template>
  <div
    ...
    id="main-nav"
  >
    <div class="w-full h-20 border-b flex px-4 items-center mb-8 mt-6">
      <img src="/img/logo.png" class="mb-2 w-40 pl-6" />
    </div>

    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1">PRINCIPALES</p>
      <NuxtLink :to="{ name: 'admin-dashboard' }" class="w-full flex items-center text-brown-600 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
      ...
      <NuxtLink :to="{ name: 'admin-analytics' }" class="w-full flex items-center text-brown-600 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
      ...
      <NuxtLink :to="{ name: 'admin-inventory' }" class="w-full flex items-center text-brown-600 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
        ...
        <span class="text-gray-700">Inventaire</span>
      </NuxtLink>
      <NuxtLink :to="{ name: 'admin-calendar' }" class="w-full flex items-center text-brown-600 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
          ...
          <span class="text-gray-700">Calendrier</span>
      </NuxtLink>
    </div>

    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1">CLIENTS</p>
      <NuxtLink :to="{ name: 'admin-addCustomer' }" class="w-full flex items-center text-brown-600 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
              d="M14.613,10c0,0.23-0.188,0.419-0.419,0.419H10.42v3.774c0,0.23-0.189,0.42-0.42,0.42s-0.419-0.189-0.419-0.42v-3.774H5.806c-0.23,0-0.419-0.189-0.419-0.419s0.189-0.419,0.419-0.419h3.775V5.806c0-0.23,0.189-0.419,0.419-0.419s0.42,0.189,0.42,0.419v3.775h3.774C14.425,9.581,14.613,9.77,14.613,10 M17.969,10c0,4.401-3.567,7.969-7.969,7.969c-4.402,0-7.969-3.567-7.969-7.969c0-4.402,3.567-7.969,7.969-7.969C14.401,2.031,17.969,5.598,17.969,10 M17.13,10c0-3.932-3.198-7.13-7.13-7.13S2.87,6.068,2.87,10c0,3.933,3.198,7.13,7.13,7.13S17.13,13.933,17.13,10"
            ></path>
          </svg>
          <span class="text-gray-700">Ajouter un client</span>
      </NuxtLink>
      <NuxtLink :to="{ name: 'admin-Reservation' }" class="w-full flex items-center text-brown-600 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
          <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            <path
          ...
          <span class="text-gray-700">Voir les réservations</span>
      </NuxtLink>
    </div>
    ...
    <div class="mb-4 px-4">
      ...
      <div
        ...
        @click="logout()"
      >
        <span class="text-gray-700">Déconnection</span>
      </div>
    </div>
  </div>
</template>
