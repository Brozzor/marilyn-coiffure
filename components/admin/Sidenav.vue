<template>
  ...
  >
    ...
    <div class="mb-4 px-4">
      ...
      <div
        class="w-full flex items-center text-brown-600 h-10 pl-4 bg-gray-200 hover:bg-gray-200 rounded-lg cursor-pointer"
      >
        ...
        <NuxtLink :to="{ name: 'admin-dashboard' }" class="text-gray-700"
      ...
      >
        ...
        <NuxtLink :to="{ name: 'admin-analytics' }" class="text-gray-700"
          >Analytics</NuxtLink
        >
        <span></span>
      </div>
      ...
      >
        ...
        <NuxtLink :to="{ name: 'admin-inventory' }" class="text-gray-700"
          >Inventaire</NuxtLink
        >
        <span></span>
      </div>
      ...
      >
        ...
        <NuxtLink :to="{ name: 'admin-calendar' }" class="text-gray-700"
          >Calendrier</NuxtLink
        >
    ...
    <div class="mb-4 px-4">
      ...
      >
        ...
        <NuxtLink :to="{ name: 'admin-bookings' }" class="text-gray-700"
          >Voir les réservations</NuxtLink
        >
        <span class=""></span>
      </div>
    </div>
