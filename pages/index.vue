  ...
  <div>
          ...
          <div class="story-text">
            <div class="story-text-left">
              ...
              <p>
                ...
                simply mmy text of the printing and typing industry Lorem Ipsum
                has been the industrys stanard dummy text ever since the when an
                g and ing indrem Ipsumf. the printing and ypese ing ndustry
                Lorem sum has been the industrysLorem Ipsum is simply dummy text
                of the printorem Ipsum is simply mmy text of the printin gbeen
                the industrys.
              </p>
        ...
        <div class="testimonial-wrapper">
          <div class="testimonial-main">
            <div class="testimonial-box">
              <p>
                ...
                indus try<br />Lorem Ipsum has een the indus try's stmmy text of
                the printing and<br />
                typeseing industry.
              </p>
          ...
          <div class="testimonial-main">
            <div class="testimonial-box">
              <p>
                Lorem Ipsum is simply dummy text of the printing and typing
                indus try<br />Lorem Ipsum has een the induy dummy text of the
                printing and<br />
                typeseing industry.
              </p>
              <span><b>Devil Shohemark,</b> CEO microsoft</span>
    ...
    <section class="container get-discount">
      <div class="row">
        ...
        <h3>
          Get Flat <b>25%</b> Discount<br />
          On Every Sunday of December
        </h3>
        <p>
          Lorem Ipsum is simply dummy text of the printing and typing indus
          try<br />
          Lorem Ipsum has een the indus try's standard dummy text Loremsimply
    ...
    <section class="container footer">
      <div class="row">
        ...
        <div class="subscribe-us clearfix">
          <h5>Subscribe us</h5>
          <p>
            Subscribe to our Newsletter to get first Gift voucher by Unique
            Barber
          </p>
          ...
          <p class="copyright">
            &copy; 2017 Made by
            <span
              ><a href="http://kalanidhithemes.com/" target="_blank">
                Kalanidhi Themes
              </a></span
            >
          </p>
